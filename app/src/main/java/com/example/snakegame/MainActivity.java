...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    // point color / single color of a snake
    ...
    private void init () {
        ...
        for (int i = 0; i < defaultTalePoints; i++){
            ...
            // increasing value for next point at snake's tail
            ...
            public void run() {
                ...
                switch (movingPosition) {
                    case "right":
                        ...
                        // moving snake's head to the right
                    ...
                    case "left":
                        ...
                        // moving snake's head to the left
                        // other points follow snake's head point to move the snake
                        snakePointsList.get(0).setPositionX(headPositionX - (pointSize * 2));
                        snakePointsList.get(0).setPositionY(headPositionY);
                        break;
                    ...
                    case "top":
                        ...
                        // moving snake's head to the top
                        // other points follow snake's head point to move the snake
                    ...
                    case "bottom":
                        ...
                        // moving snake's head to the bottom
                        // other points follow snake's head point to move the snake
                        snakePointsList.get(0).setPositionX(headPositionX);
                        snakePointsList.get(0).setPositionY(headPositionY + (pointSize * 2));
                        break;
                ...
                if(checkGameOver(headPositionX,headPositionY)){
                    ...
                    // change make's head position. other snake points will follow snake's head
                    ...
                    // other points allowing snake's head
